import { Box, Checkbox, Collapse, FormControlLabel, Link, Stack, styled } from '@mui/material'
...
const Categories = () => {
  ...
  useEffect(() => {
    API.categories.getAllCategories().then(allRegisteredCategories => setAllCategories(sort(allRegisteredCategories)))
  }, [])
